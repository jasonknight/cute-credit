...
# Generated by qmake (2.01a) (Qt 4.7.0) on: Mon Jan 16 12:01:07 2012
# Project:  ArtemaHybrid.pro
# Template: app
# Command: /usr/bin/qmake -spec /usr/share/qt4/mkspecs/linux-g++ CONFIG+=debug -o Makefile ArtemaHybrid.pro
#############################################################################
...
CC            = gcc
CXX           = g++
DEFINES       = -DQT_SQL_LIB -DQT_CORE_LIB -DQT_SHARED
...
SOURCES       = main.cpp \
		...
		database.cpp \
		artemahybrid.cpp \
		receipttemplate.cpp moc_artematimer.cpp \
		moc_reader.cpp \
		moc_fifocontroller.cpp \
		moc_mock.cpp \
		moc_database.cpp \
		moc_artemahybrid.cpp \
		moc_receipttemplate.cpp \
		qrc_cute-credit-resources.cpp
OBJECTS       = main.o \
		artematimer.o \
		reader.o \
		fifocontroller.o \
		...
		moc_database.o \
		moc_artemahybrid.o \
		moc_receipttemplate.o \
		qrc_cute-credit-resources.o
...
Makefile: ArtemaHybrid.pro  /usr/share/qt4/mkspecs/linux-g++/qmake.conf /usr/share/qt4/mkspecs/common/g++.conf \
	...
	$(QMAKE) -spec /usr/share/qt4/mkspecs/linux-g++ CONFIG+=debug -o Makefile ArtemaHybrid.pro
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/cute-credit1.0.0/ && $(COPY_FILE) --parents helpers.h artematimer.h reader.h cute_credit.h fifocontroller.h mock.h database.h artemahybrid.h paylife_structs.h receipttemplate.h .tmp/cute-credit1.0.0/ && $(COPY_FILE) --parents cute-credit-resources.qrc .tmp/cute-credit1.0.0/ && $(COPY_FILE) --parents main.cpp artematimer.cpp reader.cpp fifocontroller.cpp mock.cpp database.cpp artemahybrid.cpp receipttemplate.cpp .tmp/cute-credit1.0.0/ && (cd `dirname .tmp/cute-credit1.0.0` && $(TAR) cute-credit1.0.0.tar cute-credit1.0.0 && $(COMPRESS) cute-credit1.0.0.tar) && $(MOVE) `dirname .tmp/cute-credit1.0.0`/cute-credit1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/cute-credit1.0.0
...
compiler_moc_header_make_all: moc_artematimer.cpp moc_reader.cpp moc_fifocontroller.cpp moc_mock.cpp moc_database.cpp moc_artemahybrid.cpp moc_receipttemplate.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_artematimer.cpp moc_reader.cpp moc_fifocontroller.cpp moc_mock.cpp moc_database.cpp moc_artemahybrid.cpp moc_receipttemplate.cpp
...
moc_receipttemplate.cpp: receipttemplate.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) receipttemplate.h -o moc_receipttemplate.cpp

compiler_rcc_make_all: qrc_cute-credit-resources.cpp
compiler_rcc_clean:
	-$(DEL_FILE) qrc_cute-credit-resources.cpp
qrc_cute-credit-resources.cpp: cute-credit-resources.qrc
	/usr/bin/rcc -name cute-credit-resources cute-credit-resources.qrc -o qrc_cute-credit-resources.cpp
...
receipttemplate.o: receipttemplate.cpp receipttemplate.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o receipttemplate.o receipttemplate.cpp
...
moc_receipttemplate.o: moc_receipttemplate.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_receipttemplate.o moc_receipttemplate.cpp

qrc_cute-credit-resources.o: qrc_cute-credit-resources.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o qrc_cute-credit-resources.o qrc_cute-credit-resources.cpp
